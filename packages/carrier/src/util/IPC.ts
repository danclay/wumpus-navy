...
export class CentralStore {
	...
	/** @internal */
	public constructor(ipc: IPC<unknown>) {
		this.ipc = ipc;
	}
 ...
 */
export class IPC<LibLatencyRef> extends EventEmitter {
	...
	*/
	public getStats(): Promise<Stats<LibLatencyRef>> {
		return new Promise((resolve) => {
			const callback = (r: Stats<LibLatencyRef>) => {
				resolve(r);
			};
